...
namespace ConnectedParties
{
    public partial class FrmNewConnection : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if(cbRelationship.SelectedIndex == 2 && TxtOwnership.Text is null)
            {
                MessageBox.Show("If the relationship is connected party the percentage owned cannot be blank");
                return;
            }
            // attempt to save
            try
            {
                ...
                (int)cbRelationship.SelectedValue,Convert.ToInt32(TxtOwnership.Text));
