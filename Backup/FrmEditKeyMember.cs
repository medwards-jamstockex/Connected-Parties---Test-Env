    ...
    public partial class FrmEditKeyMember : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dResult == DialogResult.Yes)
            {
                try
                {
                    DataSource.DeleteKeyMember(txtAccountID.Text, cbMembership.SelectedValue.ToString(), cbIssuer.SelectedValue.ToString(), dpMemberJoin.Value, dpMemberResign.Value,
